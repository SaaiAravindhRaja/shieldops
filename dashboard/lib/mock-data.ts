...
export const incidents: Incident[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { id: "t17", agent: "Sherlock", action: "Code Analysis", details: "Claude identified hardcoded backdoor token. Pattern matches known supply chain attack technique.", timestamp: hoursAgo(5), tool_used: "add_evidence" },
